document.addEventListener('DOMContentLoaded', function() {
    ...
    const UploadManager = {
        validateFile(file) {
            ...
            const maxSize = 1 * 1024 * 1024; // 1MB for all files
        ...
        async compressImage(file) {
            // If it's a GIF, return the original file as data URL (no compression)
    ...
    const EventManager = {
        ...
        async handleFormSubmit(e) {
            ...
            try {
                ...
                UploadManager.setButtonState(true, isGif ? 'Processing GIF...' : 'Compressing...');
                
                try {
                    // Automatically compress the image for optimal size and quality (GIFs are not compressed)
